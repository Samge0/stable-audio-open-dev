## docker of stable-audio-open-dev
...
- build docker
    ```shell
    docker build . -t samge/stable-audio-open-dev-base -f .devcontainer/Dockerfile-dev-base --build-arg PROXY=http://192.168.50.48:7890
    ```

- upload
    ```shell
    docker push samge/stable-audio-open-dev-base
    ```
